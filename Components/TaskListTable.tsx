...
export const TaskListTable = ({tableData}: any) => {
    ...
    <table className="min-w-full">
      <thead>
        <tr className="text-left">
            <th className="py-3 px-4 text-gray-800 font-large text-[15px]">Name</th>
            <th className="py-3 px-4 text-gray-800 font-large text-[15px]">Status</th>
            <th className="py-3 px-4 text-gray-800 font-large text-[15px]">Priority</th>
            <th className="py-3 px-4 text-gray-800 font-large text-[15px] hidden md:table-cell">Created On </th>
        </tr>
      </thead>
      <tbody>
